...
THREE.GPUParticleContainer = function ( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function ( options ) {
		...
		var positionRandomness = options.positionRandomness !== undefined ? options.positionRandomness : {x:0, y:0, z:0};
		...
		positionStartAttribute.array[ i * 3 + 0 ] = position.x + ( particleSystem.random() * positionRandomness.x );
		positionStartAttribute.array[ i * 3 + 1 ] = position.y + ( particleSystem.random() * positionRandomness.y );
		positionStartAttribute.array[ i * 3 + 2 ] = position.z + ( particleSystem.random() * positionRandomness.z );
